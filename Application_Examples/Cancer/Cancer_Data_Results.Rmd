...
# CancerData.fac$`Def Loc Rx?` = as.factor(CancerData.fac$`Def Loc Rx?`)
# CancerData.fac$Strat = as.factor(CancerData.fac$Strat)
# levels(CancerData.fac$Strat) = c("High", "Low")
# CancerData.fac$Strat = as.character(CancerData.fac$Strat)
# CancerData.fac[11:18] = lapply(CancerData.fac[11:18], as.factor) # Treatment and outcomes as factor
...
tree2_MOtol1.0 = MO.tol.DTRtree(Ys = Ys2, w = w2.1, A = Trt2, H = cbind(Cov2,Y1.1),
...
tree2_MOtol1.4 = MO.tol.DTRtree(Ys = Ys2, w = w2.1, A = Trt2, H = cbind(Cov2,Y1.1),
...
# The most flexible case delta = 0 (allow all treatments) --> KA/VE is the optimal treatment at stage 2
tree2_MOtol2.0 = MO.tol.DTRtree(Ys = Ys2, w = w2.2, A = Trt2, H = cbind(Cov2,Y1.2),
                              delta = 0, tolerate = TRUE, m.method="AIPW", 
                              depth = 3, lambda.pct = 0.02, minsplit = 15)
...
tree2_MOtol2.4 = MO.tol.DTRtree(Ys = Ys2, w = w2.2, A = Trt2, H = cbind(Cov2,Y1.2),
                              delta = 0.3, tolerate = TRUE, m.method="AIPW", 
                              depth = 3, lambda.pct = 0.02, minsplit = 15)
...
tree2_MOtol3.0 = MO.tol.DTRtree(Ys = Ys2, w = w2.3, A = Trt2, H = cbind(Cov2,Y1.3),
                              delta = 0, tolerate = TRUE, m.method="AIPW", 
                              depth = 3, lambda.pct = 0.02, minsplit = 15)
knitr::kable(tree2_MOtol3.0$tree, digits = 2)
# When delta = 0.4 (allow some of the treatments) -->  KA/VE and CVD is the tolerant treatment at stage 2
tree2_MOtol3.4 = MO.tol.DTRtree(Ys = Ys2, w = w2.3, A = Trt2, H = cbind(Cov2,Y1.3),
...
1. If only care about expert score
```{r}
w1 = c(0, 1)
Y1.1 = tcrossprod(as.matrix(Outcomes1), t(w1))
# When delta = 0.3 (allow some of the treatments) -->  KA/VE and CVD is the tolerant treatment at stage 2
tree2.1 = MO.tol.DTRtree(Ys = Ys2, w = w1, A = Trt2, H = cbind(Cov2,Y1.1),
                              delta = 0.2, tolerate = TRUE, m.method="AIPW", 
                              depth = 3, lambda.pct = 0.05, minsplit = 15)
treeout2.1 = tree2.1$tree
knitr::kable(treeout2.1, digits = 2)
############### stage 1 Estimation #############################
# estimated tolerant regime for each patients
tol.trt2 <- predict_tol.DTR(treeout2.1, newdata = cbind(Cov2,Y1.1))
# Accumulated PO
PO.loss2 = tree2.1$PO.loss 
...
# The most flexible case delta = 0 (allow all treatments) --> KA/VE is the optimal treatment at stage 2
# When delta = 0.3 (allow some of the treatments) -->  KA/VE and CVD is the tolerant treatment at stage 2
tree1.1 = MO.tol.DTRtree(Ys = Ys1, w = w1, A = Trt1, H = Cov1,
                              delta = 0.2, tolerate = TRUE, m.method="AIPW", 
                              depth = 3, lambda.pct = 0.05, minsplit = 15, 
                              PO.loss = PO.loss.comp)
knitr::kable(tree1.1$tree, digits = 2)
```

2. If apply more on expert score
```{r}
w2 = c(0.2, 0.8)
Y1.2 = tcrossprod(as.matrix(Outcomes1), t(w2))
# When delta = 0.3 (allow some of the treatments) -->  KA/VE and CVD is the tolerant treatment at stage 2
tree2.2 = MO.tol.DTRtree(Ys = Ys2, w = w2, A = Trt2, H = cbind(Cov2,Y1.2),
                              delta = 0.2, tolerate = TRUE, m.method="AIPW", 
                              depth = 3, lambda.pct = 0.05, minsplit = 15)
treeout2.2 = tree2.2$tree
knitr::kable(treeout2.2, digits = 2)
############### stage 1 Estimation #############################
# estimated tolerant regime for each patients
tol.trt2 <- predict_tol.DTR(treeout2.2, newdata = cbind(Cov2,Y1.2))
# Accumulated PO
PO.loss2 = tree2.2$PO.loss 
# PO1 <- Ys1 + PO.loss2 # I have wrote this into the function MO.tol.DTRtree
PO.loss.comp = matrix(0, nrow = 144, ncol = 2)
PO.loss.comp[CancerData.clean2[,1],] = PO.loss2
...
# The most flexible case delta = 0 (allow all treatments) --> KA/VE is the optimal treatment at stage 2
# When delta = 0.3 (allow some of the treatments) -->  KA/VE and CVD is the tolerant treatment at stage 2
tree1.2 = MO.tol.DTRtree(Ys = Ys1, w = w2, A = Trt1, H = Cov1,
                              delta = 0.2, tolerate = TRUE, m.method="AIPW", 
                              depth = 3, lambda.pct = 0.05, minsplit = 15, 
                              PO.loss = PO.loss.comp)
knitr::kable(tree1.2$tree, digits = 2)
```

3. If apply equal weight on the two objectives
```{r}
w3 = c(0.5, 0.5)
Y1.3 = tcrossprod(as.matrix(Outcomes1), t(w3))
# When delta = 0.4 (allow some of the treatments) -->  KA/VE and CVD is the tolerant treatment at stage 2
tree2.3 = MO.tol.DTRtree(Ys = Ys2, w = w3, A = Trt2, H = cbind(Cov2,Y1.3),
                              delta = 0.2, tolerate = TRUE, m.method="AIPW", 
                              depth = 3, lambda.pct = 0.05, minsplit = 15)
treeout2.3 = tree2.3$tree
knitr::kable(treeout2.3, digits = 2)
############### stage 1 Estimation #############################
# estimated tolerant regime for each patients
tol.trt2 <- predict_tol.DTR(treeout2.3, newdata = cbind(Cov2,Y1.3))
# Accumulated PO
PO.loss2 = tree2.3$PO.loss 
# PO1 <- Ys1 + PO.loss2 # I have wrote this into the function MO.tol.DTRtree
PO.loss.comp = matrix(0, nrow = 144, ncol = 2)
PO.loss.comp[CancerData.clean2[,1],] = PO.loss2
...
# The most flexible case delta = 0 (allow all treatments) --> KA/VE is the optimal treatment at stage 2
# When delta = 0.3 (allow some of the treatments) -->  KA/VE and CVD is the tolerant treatment at stage 2
tree1.3 = MO.tol.DTRtree(Ys = Ys1, w = w3, A = Trt1, H = Cov1,
                              delta = 0.2, tolerate = TRUE, m.method="AIPW", 
                              depth = 3, lambda.pct = 0.05, minsplit = 15, 
                              PO.loss = PO.loss.comp)
knitr::kable(tree1.3$tree, digits = 2)
```

4. if apply more on survival time
```{r}
w4 = c(0.8, 0.2)
Y1.4 = tcrossprod(as.matrix(Outcomes1), t(w4))
# When delta = 0.3 (allow some of the treatments) -->  KA/VE and CVD is the tolerant treatment at stage 2
tree2.4 = MO.tol.DTRtree(Ys = Ys2, w = w4, A = Trt2, H = cbind(Cov2,Y1.4),
                              delta = 0.2, tolerate = TRUE, m.method="AIPW", 
                              depth = 3, lambda.pct = 0.05, minsplit = 15)
treeout2.4 = tree2.4$tree
knitr::kable(treeout2.4, digits = 2)
############### stage 1 Estimation #############################
# estimated tolerant regime for each patients
tol.trt2 <- predict_tol.DTR(treeout2.4, newdata = cbind(Cov2,Y1.4))
# Accumulated PO
PO.loss2 = tree2.4$PO.loss 
# PO1 <- Ys1 + PO.loss2 # I have wrote this into the function MO.tol.DTRtree
PO.loss.comp = matrix(0, nrow = 144, ncol = 2)
PO.loss.comp[CancerData.clean2[,1],] = PO.loss2
...
# The most flexible case delta = 0 (allow all treatments) --> KA/VE is the optimal treatment at stage 2
# When delta = 0.3 (allow some of the treatments) -->  KA/VE and CVD is the tolerant treatment at stage 2
tree1.4 = MO.tol.DTRtree(Ys = Ys1, w = w4, A = Trt1, H = Cov1,
                              delta = 0.2, tolerate = TRUE, m.method="AIPW", 
                              depth = 3, lambda.pct = 0.05, minsplit = 15, 
                              PO.loss = PO.loss.comp)
knitr::kable(tree1.4$tree, digits = 2)
```


5. If only care about survival
```{r}
w5 = c(1, 0)
Y1.5 = tcrossprod(as.matrix(Outcomes1), t(w5))
# When delta = 0.3 (allow some of the treatments) -->  KA/VE and CVD is the tolerant treatment at stage 2
tree2.5 = MO.tol.DTRtree(Ys = Ys2, w = w5, A = Trt2, H = cbind(Cov2,Y1.5),
                              delta = 0.2, tolerate = TRUE, m.method="AIPW", 
                              depth = 3, lambda.pct = 0.02, minsplit = 15)
treeout2.5 = tree2.5$tree
knitr::kable(treeout2.5, digits = 2)
############### stage 1 Estimation #############################
# estimated tolerant regime for each patients
tol.trt2 <- predict_tol.DTR(treeout2.5, newdata = cbind(Cov2,Y1.5))
# Accumulated PO
PO.loss2 = tree2.5$PO.loss 
# PO1 <- Ys1 + PO.loss2 # I have wrote this into the function MO.tol.DTRtree
PO.loss.comp = matrix(0, nrow = 144, ncol = 2)
PO.loss.comp[CancerData.clean2[,1],] = PO.loss2
...
# The most flexible case delta = 0 (allow all treatments) --> KA/VE is the optimal treatment at stage 2
# When delta = 0.3 (allow some of the treatments) -->  KA/VE and CVD is the tolerant treatment at stage 2
tree1.5 = MO.tol.DTRtree(Ys = Ys1, w = w5, A = Trt1, H = Cov1,
                              delta = 0.2, tolerate = TRUE, m.method="AIPW", 
                              depth = 3, lambda.pct = 0.02, minsplit = 25, 
                              PO.loss = PO.loss.comp)
knitr::kable(tree1.5$tree, digits = 2)
```
...
# Y1.5 = tcrossprod(as.matrix(Outcomes1), t(w5))
# When delta = 0.3 (allow some of the treatments) -->  KA/VE and CVD is the tolerant treatment at stage 2
tree2.5 = MO.tol.DTRtree(Ys = Ys2, w = w5, A = Trt2, H = cbind(Cov2),
                              delta = 0.3, tolerate = TRUE, m.method="AIPW", 
                              depth = 3, lambda.pct = 0.05, minsplit = 15)
treeout2.5 = tree2.5$tree
knitr::kable(treeout2.5, digits = 2)
############### stage 1 Estimation #############################
# estimated tolerant regime for each patients
tol.trt2 <- predict_tol.DTR(treeout2.5, newdata = cbind(Cov2))
# Accumulated PO
PO.loss2 = tree2.5$PO.loss 
# PO1 <- Ys1 + PO.loss2 # I have wrote this into the function MO.tol.DTRtree
PO.loss.comp = matrix(0, nrow = 144, ncol = 2)
...
############### stage 1 Estimation #############################
tol.trt2 <- predict_tol.DTR(treeout2, newdata = cbind(Cov2,Y1.2))
# Accumulated PO
...
tree1_MOtol1.0 = MO.tol.DTRtree(Ys = Ys1, w = w1.1, A = Trt1, H = Cov1,
                              delta = 0, tolerate = TRUE, m.method="AIPW", 
                              depth = 2, lambda.pct = 0.1, minsplit = 15,
                              PO.loss = PO.loss.comp)
...
tree1_MOtol3.0 = MO.tol.DTRtree(Ys = Ys1, w = w1.3, A = Trt1, H = Cov1,
                              delta = 0, tolerate = TRUE, m.method="AIPW", 
                              depth = 2, lambda.pct = 0.02, minsplit = 15,
                              PO.loss = PO.loss.comp)
...
# Aug23 add two more cases:

0.2ST and 0.8ES
```{r}
# here we use the second tolerant tree 
w0.3 = c(0.85, 0.15)
Y1.2 = tcrossprod(as.matrix(Outcomes1), t(w0.3))
tree2 = MO.tol.DTRtree(Ys = Ys2, w = w0.3, A = Trt2, H = cbind(Cov2,Y1.2),
                              delta = 0.3, tolerate = TRUE, m.method="AIPW",
                              depth = 3, lambda.pct = 0.05, minsplit = 15)
treeout2 = tree2$tree
knitr::kable(treeout2, digits = 2)
...
# Stage 1 tree
# The most flexible case delta = 0 (allow all treatments) --> KA/VE is the optimal treatment at stage 2
tree1_MOtol2.0 = MO.tol.DTRtree(Ys = Ys1, w = w0.3, A = Trt1, H = Cov1,
                              delta = 0, tolerate = TRUE, m.method="AIPW", 
                              depth = 3, lambda.pct = 0.05, minsplit = 15,
                              PO.loss = PO.loss.comp)
knitr::kable(tree1_MOtol2.0$tree, digits = 2)
# When delta = 0.4 (allow some of the treatments) -->  KA/VE and CVD is the tolerant treatment at stage 2
tree1_MOtol2.4 = MO.tol.DTRtree(Ys = Ys1, w = w0.3, A = Trt1, H = Cov1,
                              delta = 0.3, tolerate = TRUE, m.method="AIPW", 
                              depth = 3, lambda.pct = 0.05, minsplit = 15, 
                              PO.loss = PO.loss.comp)
...
# here we use the second tolerant tree 
w0.5 = c(0.5, 0.5)
Y1.2 = tcrossprod(as.matrix(Outcomes1), t(w0.5))
tree2 = MO.tol.DTRtree(Ys = Ys2, w = w0.5, A = Trt2, H = cbind(Cov2,Y1.2),
                              delta = 0.3, tolerate = TRUE, m.method="AIPW",
                              depth = 3, lambda.pct = 0.05, minsplit = 15)
treeout2 = tree2$tree
knitr::kable(treeout2, digits = 2)
...
# Stage 1 tree
# The most flexible case delta = 0 (allow all treatments) --> KA/VE is the optimal treatment at stage 2
tree1_MOtol2.0 = MO.tol.DTRtree(Ys = Ys1, w = w0.5, A = Trt1, H = Cov1,
                              delta = 0, tolerate = TRUE, m.method="AIPW", 
                              depth = 3, lambda.pct = 0.05, minsplit = 15,
                              PO.loss = PO.loss.comp)
knitr::kable(tree1_MOtol2.0$tree, digits = 2)
# When delta = 0.4 (allow some of the treatments) -->  KA/VE and CVD is the tolerant treatment at stage 2
tree1_MOtol2.4 = MO.tol.DTRtree(Ys = Ys1, w = w0.5, A = Trt1, H = Cov1,
                              delta = 0.3, tolerate = TRUE, m.method="AIPW", 
                              depth = 3, lambda.pct = 0.05, minsplit = 15, 
                              PO.loss = PO.loss.comp)
knitr::kable(tree1_MOtol2.4$tree, digits = 2)
...
# here we use the second tolerant tree 
w0.8 = c(0.15, 0.85)
Y1.2 = tcrossprod(as.matrix(Outcomes1), t(w0.8))
tree2 = MO.tol.DTRtree(Ys = Ys2, w = w0.8, A = Trt2, H = cbind(Cov2,Y1.2),
                              delta = 0.2, tolerate = TRUE, m.method="AIPW",
                              depth = 3, lambda.pct = 0.05, minsplit = 15)
treeout2 = tree2$tree
knitr::kable(treeout2, digits = 2)
...
# Stage 1 tree
# The most flexible case delta = 0 (allow all treatments) --> KA/VE is the optimal treatment at stage 2
tree1_MOtol2.0 = MO.tol.DTRtree(Ys = Ys1, w = w0.8, A = Trt1, H = Cov1,
                              delta = 0, tolerate = TRUE, m.method="AIPW", 
                              depth = 3, lambda.pct = 0.05, minsplit = 15,
                              PO.loss = PO.loss.comp)
knitr::kable(tree1_MOtol2.0$tree, digits = 2)
# When delta = 0.4 (allow some of the treatments) -->  KA/VE and CVD is the tolerant treatment at stage 2
tree1_MOtol2.4 = MO.tol.DTRtree(Ys = Ys1, w = w0.8, A = Trt1, H = Cov1,
                              delta = 0.3, tolerate = TRUE, m.method="AIPW", 
                              depth = 3, lambda.pct = 0.05, minsplit = 15, 
                              PO.loss = PO.loss.comp)
knitr::kable(tree1_MOtol2.4$tree, digits = 2)
