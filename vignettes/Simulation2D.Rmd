...
(i) Small sample size (N = 500), small noise (~N(0,1))
(ii) Large sample size (N = 1000), small noise (~N(0,1))
...
(iii) Small sample size (N = 500), large noise (~N(0,5))
(iv) Large sample size (N = 1000), large noise (~N(0,5))
